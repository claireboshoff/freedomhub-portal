import{j as e,r as g,u as D,a as y}from"./index-D6dyrzHb.js";const j=[{level:1,xp:0,title:"Newcomer"},{level:2,xp:100,title:"Explorer"},{level:3,xp:300,title:"Learner"},{level:4,xp:600,title:"Achiever"},{level:5,xp:1e3,title:"Rising Star"},{level:6,xp:1500,title:"Knowledge Seeker"},{level:7,xp:2500,title:"Trailblazer"},{level:8,xp:4e3,title:"Expert"},{level:9,xp:6e3,title:"Master"},{level:10,xp:1e4,title:"Legend"}];function T(a){const t=j.find(d=>d.level===a);return t?t.title:"Newcomer"}function E(a){const t=j.find(d=>d.level===a);return t?t.xp:0}function I(a){const t=j.find(d=>d.level===a+1);return t?t.xp:null}function V(a){const t=j.find(d=>d.level===a+1);return t?t.title:null}function H(a,t){const d=E(t),n=I(t);if(n===null)return 100;const l=n-d,o=a-d;return Math.min(100,Math.max(0,o/l*100))}function R({streak:a=0,longestStreak:t=0,lastActive:d}){const n=new Date,l=d?new Date(d):null,o=l?Math.floor((n-l)/(1e3*60*60*24)):null,s=o===1,r=o===0,u=a>7,c=["M","T","W","T","F","S","S"],m=new Date;m.getDay();const h=[];for(let x=6;x>=0;x--){const p=new Date(m);p.setDate(p.getDate()-x);const v=p.getDay(),w=x,N=a>0&&w<a&&(r||s&&w>0);h.push({label:c[v===0?6:v-1],active:N})}const _=a===0?"Start your streak!":s?"Keep it going! Log in today.":"Keep it going!";return e.jsxs("div",{className:"streak-widget",children:[e.jsx("style",{children:`
        .streak-widget {
      ...
      `}),e.jsxs("div",{className:"badge-grid-widget__header",children:[e.jsx("h3",{className:"badge-grid-widget__title",children:"Badges"}),e.jsxs("span",{className:"badge-grid-widget__count",children:[l," of ",M.length," earned"]})]}),e.jsx("div",{className:"badge-grid-widget__grid",children:M.map(o=>{const s=n.has(o.id),r=s?"#c5a55a":"#9ca3af";return e.jsxs("div",{className:"badge-grid-widget__item",onClick:()=>d(o),children:[e.jsxs("div",{className:`badge-grid-widget__icon-wrap ${s?"badge-grid-widget__icon-wrap--earned":"badge-grid-widget__icon-wrap--locked"}`,children:[o.icon(r),!s&&e.jsx("div",{className:"badge-grid-widget__lock",children:e.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"#6b7280",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("rect",{x:"3",y:"11",width:"18",height:"11",rx:"2",ry:"2"}),e.jsx("path",{d:"M7 11V7a5 5 0 0 1 10 0v4"})]})})]}),e.jsx("span",{className:`badge-grid-widget__name ${s?"badge-grid-widget__name--earned":"badge-grid-widget__name--locked"}`,children:o.name})]},o.id)})}),t&&e.jsx("div",{className:"badge-grid-widget__overlay",onClick:()=>d(null),children:e.jsxs("div",{className:"badge-grid-widget__detail",onClick:o=>o.stopPropagation(),children:[e.jsx("div",{className:`badge-grid-widget__detail-icon ${n.has(t.id)?"badge-grid-widget__detail-icon--earned":"badge-grid-widget__detail-icon--locked"}`,children:t.icon(n.has(t.id)?"#c5a55a":"#9ca3af")}),e.jsx("div",{className:"badge-grid-widget__detail-name",children:t.name}),e.jsx("div",{className:`badge-grid-widget__detail-status ${n.has(t.id)?"badge-grid-widget__detail-status--earned":"badge-grid-widget__detail-status--locked"}`,children:n.has(t.id)?"Earned":"Locked"}),e.jsx("div",{className:"badge-grid-widget__detail-criteria",children:t.criteria}),e.jsx("button",{className:"badge-grid-widget__detail-close",onClick:()=>d(null),children:"Close"})]})})]})}function U({level:a,previousLevel:t}){const[d,n]=g.useState(!1);if(g.useEffect(()=>{if(!a||!t||a<=t)return;const s=`levelup_shown_${a}`;if(sessionStorage.getItem(s))return;const r=setTimeout(()=>{n(!0),sessionStorage.setItem(s,"true")},600);return()=>clearTimeout(r)},[a,t]),!d)return null;const l=T(a),o=Array.from({length:40},(s,r)=>({id:r,left:Math.random()*100,delay:Math.random()*1.5,duration:2+Math.random()*2,size:4+Math.random()*6,color:["#c5a55a","#d4b96e","#ef4444","#8b5cf6","#10b981","#0ea5e9","#f59e0b"][r%7],rotation:Math.random()*360}));return e.jsxs("div",{className:"levelup-modal__overlay",children:[e.jsx("style",{children:`
      ...
      `}),e.jsx("div",{className:"levelup-modal__confetti-container",children:o.map(s=>e.jsx("div",{className:"levelup-modal__confetti",style:{left:`${s.left}%`,width:`${s.size}px`,height:`${s.size*1.5}px`,background:s.color,animationDelay:`${s.delay}s`,animationDuration:`${s.duration}s`,transform:`rotate(${s.rotation}deg)`}},s.id))}),e.jsxs("div",{className:"levelup-modal__card",children:[e.jsx("div",{className:"levelup-modal__star",children:e.jsx("svg",{width:"56",height:"56",viewBox:"0 0 24 24",fill:"none",children:e.jsx("path",{d:"M12 2l3.09 6.26L22 9.27l-5 4.87L18.18 21 12 17.77 5.82 21 7 14.14l-5-4.87 6.91-1.01L12 2z",fill:"#c5a55a",stroke:"#a88d44",strokeWidth:"1"})})}),e.jsx("div",{className:"levelup-modal__heading",children:"Level Up!"}),e.jsx("div",{className:"levelup-modal__level",children:a}),e.jsx("div",{className:"levelup-modal__title",children:l}),e.jsxs("div",{className:"levelup-modal__message",children:["You have reached Level ",a,". Keep learning and earning XP to unlock new achievements."]}),e.jsx("button",{className:"levelup-modal__btn",onClick:()=>n(!1),children:"Continue"})]})]})}const K={course:"#C5A55A",quest:"#8b5cf6",challenge:"#ef4444","meditation series":"#10b981","podcast series":"#0ea5e9"},O={1:e.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",children:[e.jsx("circle",{cx:"12",cy:"8",r:"6",fill:"#c5a55a",stroke:"#a88d44",strokeWidth:"1"}),e.jsx("path",{d:"M15.477 12.89L17 22l-5-3-5 3 1.523-9.11",fill:"#c5a55a",stroke:"#a88d44",strokeWidth:"1"}),e.jsx("text",{x:"12",y:"10.5",textAnchor:"middle",fill:"white",fontSize:"7",fontWeight:"bold",fontFamily:"sans-serif",children:"1"})]}),2:e.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",children:[e.jsx("circle",{cx:"12",cy:"8",r:"6",fill:"#9ca3af",stroke:"#6b7280",strokeWidth:"1"}),e.jsx("path",{d:"M15.477 12.89L17 22l-5-3-5 3 1.523-9.11",fill:"#9ca3af",stroke:"#6b7280",strokeWidth:"1"}),e.jsx("text",{x:"12",y:"10.5",textAnchor:"middle",fill:"white",fontSize:"7",fontWeight:"bold",fontFamily:"sans-serif",children:"2"})]}),3:e.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",children:[e.jsx("circle",{cx:"12",cy:"8",r:"6",fill:"#b45309",stroke:"#92400e",strokeWidth:"1"}),e.jsx("path",{d:"M15.477 12.89L17 22l-5-3-5 3 1.523-9.11",fill:"#b45309",stroke:"#92400e",strokeWidth:"1"}),e.jsx("text",{x:"12",y:"10.5",textAnchor:"middle",fill:"white",fontSize:"7",fontWeight:"bold",fontFamily:"sans-serif",children:"3"})]})};function P({course:a,enrolled:t,onClick:d}){const n=(a.type||"course").toLowerCase(),l=K[n]||"#C5A55A";return e.jsxs("div",{className:"card course-card",onClick:d,style:{cursor:"pointer"},children:[e.jsxs("div",{className:"course-card__thumbnail",children:[a.thumbnail?e.jsx("img",{src:a.thumbnail,alt:a.title}):e.jsx("div",{className:"course-card__placeholder"}),e.jsx("span",{className:"course-card__type-pill",style:{background:l},children:a.type||"Course"})]}),e.jsxs("div",{className:"card__body course-card__body",children:[e.jsx("h4",{className:"course-card__title",children:a.title}),a.category&&e.jsx("span",{className:"course-card__category",children:a.category}),e.jsxs("div",{className:"course-card__meta",children:[a.lessonCount!=null&&e.jsxs("span",{children:[a.lessonCount," lesson",a.lessonCount!==1?"s":""]}),a.estimatedDuration&&e.jsx("span",{children:a.estimatedDuration})]}),t?e.jsxs("div",{className:"course-card__progress",children:[e.jsx("div",{className:"progress-bar progress-bar--sm",children:e.jsx("div",{className:"progress-bar__fill",style:{width:`${t.progressPercent||0}%`}})}),e.jsxs("span",{className:"course-card__progress-text",children:[t.progressPercent||0,"%"]})]}):e.jsx("div",{className:"course-card__price",children:a.price&&a.price>0?e.jsxs("span",{className:"course-card__price-badge",children:["R",a.price.toLocaleString(),a.priceUsd?` / $${a.priceUsd}`:""]}):e.jsx("span",{className:"course-card__price-badge course-card__price-badge--free",children:"Free"})})]})]})}function Q(){const a=D(),[t,d]=g.useState(!0),[n,l]=g.useState([]),[o,s]=g.useState([]),[r,u]=g.useState(null),[c,m]=g.useState([]),[h,_]=g.useState(null),[x,p]=g.useState(null);if(g.useEffect(()=>{const i=sessionStorage.getItem("academy_known_level");i&&p(parseInt(i,10)),Promise.all([y.myEnrollments().catch(()=>({enrollments:[]})),y.coursesPublished().catch(()=>({courses:[]})),y.myProgress().catch(()=>({xp:0,streak:0,longestStreak:0,level:1,badges:[],lastActive:null})),y.leaderboard().catch(()=>({leaderboard:[],userRank:null}))]).then(([k,z,f,b])=>{l(k.enrollments||[]),s(z.courses||[]),u(f),m(b.leaderboard||[]),_(b.userRank);const $=(f==null?void 0:f.level)||1;i||p($),sessionStorage.setItem("academy_known_level",String($)),d(!1)})},[]),t)return e.jsxs("div",{className:"page-loading",children:[e.jsx("div",{className:"spinner"}),e.jsx("p",{children:"Loading your academy..."})]});const v=(r==null?void 0:r.xp)||0,w=(r==null?void 0:r.streak)||0,N=(r==null?void 0:r.longestStreak)||0,L=(r==null?void 0:r.level)||1,C=(r==null?void 0:r.badges)||[],Y=(r==null?void 0:r.lastActive)||null,S={};n.forEach(i=>{S[i.courseId]=i});const W=new Set(n.map(i=>i.courseId));o.forEach(i=>{i.enrolled&&W.add(i.id)});const A=o.filter(i=>!W.has(i.id)),q=A.filter(i=>i.featured),B=q.length>0?q:A.slice(0,4);return e.jsxs("div",{className:"academy-page",children:[e.jsx("style",{children:`
