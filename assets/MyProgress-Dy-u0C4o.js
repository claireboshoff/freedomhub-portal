import{u as y,r as n,a as k,j as e}from"./index-D6dyrzHb.js";function z(){const l=y(),[h,p]=n.useState(!0),[f,u]=n.useState(null),[_,b]=n.useState(null);if(n.useEffect(()=>{k.myLearningProgress().then(s=>{u(s),p(!1)}).catch(s=>{b(s.message||"Failed to load progress"),p(!1)})},[]),h)return e.jsxs("div",{className:"page-loading",children:[e.jsx("div",{className:"spinner"}),e.jsx("p",{children:"Loading your progress..."})]});if(_)return e.jsxs("div",{className:"mp__error",children:[e.jsx("p",{children:_}),e.jsx("button",{className:"btn btn--primary",onClick:()=>l("/learn"),children:"Back to Academy"})]});const{stats:t,activeCourses:d,completedCourses:c,activityDays:v,badges:o,learningStats:r}=f,x=new Date,g=[],j=new Set(v||[]);for(let s=29;s>=0;s--){const a=new Date(x);a.setDate(a.getDate()-s);const i=a.toISOString().split("T")[0];g.push({date:i,dayLabel:a.getDate(),active:j.has(i)})}const m=s=>s?new Date(s).toLocaleDateString("en-ZA",{day:"numeric",month:"short",year:"numeric"}):"",N=s=>{if(!s)return"0m";if(s<60)return`${s}m`;const a=Math.floor(s/60),i=s%60;return i>0?`${a}h ${i}m`:`${a}h`};return e.jsxs("div",{className:"mp__page",children:[e.jsx("style",{children:`
        .mp__page {
          max-width: 960px;
          margin: 0 auto;
